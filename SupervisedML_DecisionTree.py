...
X_train, X_test, y_train, y_test = train_test_split(CCdata, CClabels, test_size=0.3, shuffle=False)
...
for i in range(len(y_train)):
    binned_y_train.append(y_train[i] - y_train[i]%5)
for i in range(len(y_test)):
    binned_y_test.append(y_test[i] - y_test[i]%5) 
