...
(n_samples, n_features), n_digits = CCdata.shape, np.unique(binned_CClabels).size
...
bench_k_means(kmeans=kmeans, name="k-means++", data=CCdata, labels=binned_CClabels)

kmeans = KMeans(init="random", n_clusters=n_digits, n_init=4, random_state=0)
bench_k_means(kmeans=kmeans, name="random", data=CCdata, labels=binned_CClabels)

pca = PCA(n_components=n_digits).fit(CCdata)
kmeans = KMeans(init=pca.components_, n_clusters=n_digits, n_init=1)
bench_k_means(kmeans=kmeans, name="PCA-based", data=CCdata, labels=binned_CClabels)

print(82 * "_")

reduced_data = PCA(n_components=2).fit_transform(CCdata)
